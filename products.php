...
<!-- Start All Products -->
  <div class="all-prod" style="background-color: #FFE7FA;">
    <div class="container">
        <div class="sub-container pt-4 pb-4">
            <div class="categ-header text-center">
                <div class="sub-title d-flex align-items-center justify-content-center mb-2">
                    ...
                    <span class="fw-bold" style="color: #2A91E7;">Categories & Brands</span>
                </div>
                <h2 class="fw-bold" style="color: #2A91E7;">Browse By Category & Brand</h2>
            </div>
            <div class="row mx-0">
                <div class="col-md-2 side-nav p-0" style="background-color: #FFE7FA; border-right: 2px solid #2A91E7;">
                    <!-- side nav -->
                    <!-- brands to display -->
                    <ul class="navbar-nav me-auto p-3">
                        <li class="nav-item d-flex align-items-center gap-2 mb-3">
                            <span class="shape bg-primary rounded-circle d-inline-block" style="width: 8px; height: 8px; background-color: #2A91E7;"></span>
                            <a href="products.php" class="nav-link fw-bolder nav-title" style="color: #2A91E7;">
                                <h4>Brands</h4>
                            </a>
                        </li>
                        <?php getBrands(); ?>
                    </ul>
                    <div class="divider my-3" style="border-top: 2px solid #2A91E7;"></div>
